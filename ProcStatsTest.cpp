...
TEST_F(ProcStatsTest, MemStatsFromFile_FailedTotalMemReadingTriggerZeros) {
#ifdef LR_DEBUG
   MockProcStats procStats;
...
TEST_F(ProcStatsTest, MemStatsFromFile_FailedReservedMemoryReturnZero) {
#ifdef LR_DEBUG
   MockProcStats procStats;
...
TEST_F(ProcStatsTest, CompareSysConfWithMemFile) {
#ifdef LR_DEBUG
   ProcStats& procStats(ProcStats::Instance());
   procStats.ThreadRegister("TEST");
