...
TEST_F(DiskPacketCaptureTest, FlushABigSession) {
   ...
   validDpiMsg->set_session(UNKNOWN_SESSIONID);
...
TEST_F(DiskPacketCaptureTest, MemoryLimits) {
   ...
   conf.mPCapCaptureMemoryLimit = 10;
   {
      ...
      dpiMsg1->set_session("012345678901234567890123456789012345");
      ...
      dpiMsg2->set_session("012345678901234567890123456789012346");
...
TEST_F(DiskPacketCaptureTest, AutoFlushOnMemoryLimit_FlushingToManyLocations) {
   ...
   conf.mPCapCaptureMemoryLimit = 10;
   {
      ...
      dpiMsg->set_session("012345678901234567890123456789012346");
      capture.SavePacket(dpiMsg, &packet);
