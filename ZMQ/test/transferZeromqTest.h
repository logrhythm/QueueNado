...
#endif
class transferZeromqTest : public ::testing::Test
{
public:
    transferZeromqTest() : mPacketsSeen(0),mPacketsToTest(1),t_smallData(NULL), t_bigData(NULL), t_bigDataSize(0)  {}
    virtual ~transferZeromqTest() {
    	if (t_smallData){
    		delete[] t_smallData;
    	}
    	if (t_bigData) {
